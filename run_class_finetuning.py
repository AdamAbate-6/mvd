...
def get_args():
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['Kinetics-400', 'SSV2', 'UCF101', 'HMDB51','image_folder', 'CAML'],
...
def main(args, ds_init):
    ...
    if args.finetune:
        if args.finetune.startswith('https'):
            ...
            # NOTE: Had to explicitly set weights_only=False because of default change in pytorch version 2.6
